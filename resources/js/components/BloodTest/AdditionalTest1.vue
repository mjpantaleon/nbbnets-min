<template>
  <div class="main-div">
        ...
        <h4><b-icon icon="droplet-half"></b-icon> ACPIH/ IgG</h4>
        <hr>
            ...
            <table class="table table-striped table-bordered">
              ...
              <tbody>
                <tr v-for="(input, i) in inputs" :key="i">
                  ...
                  <td>
                    <b-form-select v-model="input.ACPIH" :options="acpih_options"></b-form-select>
                  </td>

                  <td>
                    <b-form-select v-model="input.IGG" :options="igg_options"></b-form-select>
                  </td>
